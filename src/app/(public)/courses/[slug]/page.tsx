  ...
  return (
    <main id="main-content" className="section-padding pt-24">
      <div className="container-wide max-w-4xl">
        ...
        {course.image_url && <img src={course.image_url} alt={`${course.title} course cover`} loading="lazy" className="w-full h-64 md:h-80 object-cover rounded-2xl mb-8" />}
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-1">
                {lessons.map((l, i) => {
                  ...
                  return (
                    <Link key={l.id} href={`/courses/${slug}/lessons/${l.id}`} className="flex items-center gap-3 p-3 rounded-lg hover:bg-surface-secondary transition-colors group">
