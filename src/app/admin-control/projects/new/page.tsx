      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            <div><label htmlFor="proj-title" className="text-sm font-medium mb-1 block">Title *</label><Input id="proj-title" name="title" required value={form.title} onChange={e => update('title', e.target.value)} placeholder="My Awesome Project" /></div>
            ...
            <div className="flex items-center gap-4">
              <label htmlFor="proj-featured" className="flex items-center gap-2 cursor-pointer"><input id="proj-featured" name="featured" type="checkbox" checked={form.featured} onChange={e => update('featured', e.target.checked)} className="rounded" /><span className="text-sm text-text-secondary">Featured</span></label>
              <label htmlFor="proj-isPublished" className="flex items-center gap-2 cursor-pointer"><input id="proj-isPublished" name="isPublished" type="checkbox" checked={form.isPublished} onChange={e => update('isPublished', e.target.checked)} className="rounded" /><span className="text-sm text-text-secondary">Published</span></label>
            </div>
          </CardContent>
        </Card>
