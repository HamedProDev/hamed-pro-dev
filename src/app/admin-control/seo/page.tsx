    ...
    <div className="max-w-3xl space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div><label htmlFor="seo-title" className="text-sm font-medium mb-1 block">Default Meta Title Template</label><Input id="seo-title" name="metaTitle" defaultValue="%s | Hamed Hussein" /></div>
