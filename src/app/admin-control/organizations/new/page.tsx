      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            <div><label htmlFor="org-name" className="text-sm font-medium mb-1 block">Name *</label><Input id="org-name" name="name" required value={form.name} onChange={e => update('name', e.target.value)} placeholder="Organization name" /></div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div><label htmlFor="org-location" className="text-sm font-medium mb-1 block">Location</label><Input id="org-location" name="location" value={form.location} onChange={e => update('location', e.target.value)} placeholder="Kigali, Rwanda" /></div>
              <div><label htmlFor="org-team" className="text-sm font-medium mb-1 block">Team Size</label><Input id="org-team" name="team" value={form.team} onChange={e => update('team', e.target.value)} placeholder="10-20" /></div>
            </div>
            <div className="grid grid-cols-2 gap-4">
