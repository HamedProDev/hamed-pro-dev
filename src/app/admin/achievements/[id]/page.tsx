    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="max-w-xl space-y-6">
        <div>
          ...
          <input type="text" required value={form.title} onChange={e => setForm({ ...form, title: e.target.value })} className="w-full px-4 py-2.5 rounded-lg bg-dark-700 border border-dark-500 text-text-primary focus:border-blue-500 focus:outline-none" />
        </div>
        <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text" required value={form.year} onChange={e => setForm({ ...form, year: e.target.value })} className="w-full px-4 py-2.5 rounded-lg bg-dark-700 border border-dark-500 text-text-primary focus:border-blue-500 focus:outline-none" />
          </div>
          <div>
        ...
        <div>
          ...
          <input type="url" value={form.link} onChange={e => setForm({ ...form, link: e.target.value })} className="w-full px-4 py-2.5 rounded-lg bg-dark-700 border border-dark-500 text-text-primary focus:border-blue-500 focus:outline-none" />
        </div>
        <div>
