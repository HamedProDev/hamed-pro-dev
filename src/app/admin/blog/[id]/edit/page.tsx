  ...
  return (
    <div>
      ...
      <div className="max-w-3xl rounded-xl border border-dark-500 bg-dark-700 p-6 space-y-4">
        ...
        <div><label className="text-sm text-text-secondary">Content (Markdown)</label><textarea className="w-full mt-1 rounded-lg border border-dark-500 bg-dark-800 px-3 py-2 text-sm text-text-primary font-mono h-64" /></div>
