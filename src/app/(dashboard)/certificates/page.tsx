...
import { Award, Loader2, Download, ExternalLink, BadgeCheck } from 'lucide-react'
...
export default function CertificatesPage() {
  ...
  return (
    <div>
      <MetadataInjector title="My Certificates" description="Certificates earned by completing free courses." url="/certificates" />
