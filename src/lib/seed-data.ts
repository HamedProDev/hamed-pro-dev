...
// NOTE: all course prices are intentionally 'Free'.
...
export const seedCourses = [
        ...
        { title: 'Node.js & Express — Complete Backend Guide', slug: 'nodejs-express-complete-guide', description: 'Master backend development with Node.js, Express, REST APIs, authentication, file uploads, and deployment.', content: '## What You\'ll Learn\n\n- Express.js routing and middleware\n- Building RESTful APIs\n- JWT authentication and authorization\n- File uploads with Multer\n- Database integration with MongoDB\n- Deploying to production\n\n## Who This Is For\n\nDevelopers who want to build scalable backend services.', category: 'Backend', level: 'intermediate', price: 'Free', duration: '10 weeks', image_url: 'https://images.unsplash.com/photo-1627398242454-45a1465c2479?w=800&h=400&fit=crop', featured: true, is_published: true, order_index: 2 },
