  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-text-muted">Students must pass this quiz (70%+) to earn their certificate. Leave empty to issue the certificate automatically.</p>
      </CardHeader>
      <CardContent className="space-y-4">
        {quiz.length === 0 && <p className="text-sm text-text-muted">No final quiz questions added.</p>}
        {quiz.map((q, qIdx) => (
